...
class SendTemplateSMS
{
    ...
    private $accountSid= '8a216da85b602cda015b8e3dbcb51405';

    //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
    private $accountToken= 'd5a12705cc074c15b33ee4be79bc964d';

    //应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
    //在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
    private $appId='8a216da85b602cda015b8e3dbf3f140b';
