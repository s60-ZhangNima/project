...
Route::post('/admin/serve-updates/{id}','Admin\ServeController@ServeUpdates');
 ...
 //后台相册管理
Route::get('/admin/adminphoto','admin\photoController@photo');
Route::get('/admin/adminphotolist/{id}','admin\photoController@photolist');
//编辑相册
Route::get('/admin/adminrephoto/{id}','admin\photoController@rephoto');
Route::post('/admin/adminrephoto','admin\photoController@rephotos');
//删除相册
Route::get('/admin/admindelphoto/{id}','admin\photoController@delphoto');

//相册增加
Route::get('/admin/adminaddphoto','admin\photoController@addphoto');
Route::post('/admin/adminaddphoto','admin\photoController@addphotos');
//照片增加
Route::get('/admin/adminaddphotolist/{id}','admin\photoController@addphotolist');
Route::post('/admin/adminaddphotolist','admin\photoController@addphotolists');
//删除照片
Route::get('/admin/admindelphotolist/{id}','admin\photoController@delphotolist');
//后台留言板管理
Route::get('/admin/adminboard','admin\boardController@board');
//新增留言
Route::get('/admin/adminaddboard','admin\boardController@addboard');
Route::post('/admin/adminaddboard','admin\boardController@addboards');
//删除留言
Route::get('/admin/admindelboard/{id}','admin\boardController@delboard');
//新增回复
//Route::get('/adminaddbboard','admin\boardController@bboard');
//删除回复
Route::get('/admin/admindelbboard/{id}','admin\boardController@delbboard');
//回复留言
Route::get('/admin/adminbboard/{id}','admin\boardController@bboard');


//日志管理


Route::get('/admin/admindaily','admin\dailyController@board');
//新增日志
//Route::get('/adminadddaily','admin\dailyController@addboard');
//Route::post('/adminadddaily','admin\dailyController@addboards');
//删除日志
Route::get('/admin/admindeldaily/{id}','admin\dailyController@delboard');
//删除评论
Route::get('/admin/admindelcomment/{id}','admin\dailyController@delbboard');
//评论
Route::get('/admin/admincomment/{id}','admin\dailyController@bboard');

//广告管理
Route::get('/admin/adminadvert','admin\advertController@advert');
//增加图片
Route::get('/admin/adminaddadvert','admin\advertController@addadvert');
Route::post('/admin/adminaddadvert','admin\advertController@addadverts');
//删除图片
Route::get('/admin/admindeladvert/{id}','admin\advertController@deladvert');
//更换图片
Route::get('/admin/adminreadvert/{id}','admin\advertController@readvert');
Route::post('/admin/adminreadvert','admin\advertController@readverts');
//后台处理反馈
Route::get('/admin/adminfeedback','admin\feedbackController@feedback');
//删除反馈
Route::get('/admin/admindelfeedback/{id}','admin\feedbackController@delfeedback');

//留言板
Route::get('/home/board','boardController@board');
Route::get('/home/board/{id}','boardController@rreport');
Route::post('/home/board','boardController@report');
Route::post('/home/bboard','boardController@reports');
Route::get('/home/boards/{id}','boardController@del');
//日志
Route::get('/home/daily','dailyController@daily');
Route::get('/home/daily/{id}','dailyController@rreport');
Route::post('/home/daily','dailyController@report');
Route::post('/home/comment','dailyController@reports');
Route::get('/home/comdel/{id}','dailyController@del');
Route::get('/home/mydaily','dailyController@mydaily');
...
//新建相册
//Route::post('/percreate','photoController@percreate');

Route::get('/home/photo','photoController@photo');
Route::get('/home/createphoto','photoController@createphoto');
Route::post('/home/createphoto','photoController@percreate');
//Route::post('/createphoto','photoController@createlist');
//上传照片
Route::get('/home/photolist/{id}','photoController@photolist');

Route::get('/home/imgs','photoController@per_photo');
Route::post('/home/imgs','photoController@upphotos');
Route::get('/home/imgs/{id}','photoController@upphoto');
//Route::post('/img','photoController@per_photo')
//前台反馈
Route::get('/home/feedback','feedbackController@feedback');
Route::post('/home/feedback','feedbackController@feedbacks');
